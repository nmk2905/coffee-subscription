...
namespace Repositories.Base
{
    ...
    {
        protected coffee_subscription_systemContext _context;
        ...
        {
            _context ??= new coffee_subscription_systemContext();
        }

        public GenericRepository(coffee_subscription_systemContext context)
        {
            _context = context;
        }
